...
ServerConfig::ServerConfig(void) : _host(""), _port(0), _root(""), _index(""), _client_max_body_size(0), _error_pages(), _locations() {};

ServerConfig::ServerConfig(const ServerConfig& other) : _host(other._host), _port(other._port), _root(other._root), _index(other._index), _client_max_body_size(other._client_max_body_size), _error_pages(other._error_pages), _locations(other._locations) {};
