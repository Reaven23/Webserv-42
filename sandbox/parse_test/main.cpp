...
static void printResult(const ParsedHttpRequest& r) {
    std::cout << "status: ";
    if (r.status == OK)
        std::cout << "OK";
...
int main() {
    ...
    ParsedHttpRequest r1 = HttpRequest::parse(raw1);
    printResult(r1);
    ...
    std::string raw2 =
        ...
        "Content-Length: 11\r\n\r\nhello world";
    ParsedHttpRequest r2 = HttpRequest::parse(raw2);
    printResult(r2);

    // 3) POST incomplet (body tronque)
    std::string raw3 =
        "POST /x HTTP/1.1\r\nHost: localhost\r\nContent-Length: 10\r\n\r\nabc";
    ParsedHttpRequest r3 = HttpRequest::parse(raw3);
    printResult(r3);
    ...
    std::string raw4 =
        "GET /a HTTP/1.1\r\nHost: localhost\r\n\r\n"
        "GET /b HTTP/1.1\r\nHost: localhost\r\n\r\n";
    ParsedHttpRequest r4a = HttpRequest::parse(raw4);
    printResult(r4a);
    if (r4a.status == OK) {
        raw4.erase(0, r4a.consumed);
        ParsedHttpRequest r4b = HttpRequest::parse(raw4);
        printResult(r4b);
    }
    ...
    std::string raw5 =
        ...
        "0\r\n"
        "\r\n";
    ParsedHttpRequest r5 = HttpRequest::parse(raw5);
    printResult(r5);
    ...
    std::string raw6 =
        ...
        "4\r\nWiki\r\n"
        "5\r\npedi";
    ParsedHttpRequest r6 = HttpRequest::parse(raw6);
    printResult(r6);
    ...
    std::string raw7 =
        ...
        "0\r\n"
        "\r\n";
    ParsedHttpRequest r7 = HttpRequest::parse(raw7);
    printResult(r7);
